...
class NoticesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create notice" do
    assert_difference("Notice.count") do
      post notices_url, params: { notice: { descripcion: @notice.descripcion, title: @notice.title, users_id: @notice.users_id } }
    end
  ...
  test "should update notice" do
    patch notice_url(@notice), params: { notice: { descripcion: @notice.descripcion, title: @notice.title, users_id: @notice.users_id } }
